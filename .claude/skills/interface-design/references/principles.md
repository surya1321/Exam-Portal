...
- [Surface & Token Architecture](#surface--token-architecture) — Primitives, elevation, subtlety, text hierarchy, borders, controls
- [Spacing System](#spacing-system) — Base units, spacing scales
- [Symmetrical Padding](#symmetrical-padding) — TLBR consistency
- [Border Radius Consistency](#border-radius-consistency) — Personality through corners
- [Depth & Elevation Strategy](#depth--elevation-strategy) — Borders-only, shadows, layered, surface shifts
- [Card Layouts](#card-layouts) — Content-driven internal structure
- [Isolated Controls](#isolated-controls) — Custom form elements
- [Typography Hierarchy](#typography-hierarchy) — Headlines, body, labels, data
- [Monospace for Data](#monospace-for-data) — Tabular nums, alignment
- [Iconography](#iconography) — Clarify, don't decorate
- [Animation](#animation) — Speed, easing, professionalism
- [Contrast Hierarchy](#contrast-hierarchy) — Four-level system
- [Color Carries Meaning](#color-carries-meaning) — Gray = structure, color = communication
- [Navigation Context](#navigation-context) — Grounding screens in product context
- [Dark Mode](#dark-mode) — Borders over shadows, desaturated semantics
